...
<body>
    ...
    <main class="container">
        <section class="card">
            ...
            <p class="small">Send en kort besked om dig selv og hvorfor du vil være en del af community'et.</p>
            <form id="appForm">
                <label>Navn</label>
                <input type="text" name="name" required>
                <label>Discord</label>
                <input type="text" name="discord" required>
                <label>Job præference</label>
                <input type="text" name="job_pref" placeholder="fx police, ems, civil">
                <label>Fortæl om dig selv</label>
